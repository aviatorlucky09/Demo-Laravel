    ...
    <div class="row  justify-content-md-center">
      <div class="col-md-6  ">
        <div class="col-md-12">
          ...
          <input name="full_name" type="text"  class="form-control m-b-5" value="{{ $obj->full_name }}" />
        </div>
        <div class="col-md-12">
          <label class="col-form-label">Designation</label>
          <input name="designation" type="text"  class="form-control m-b-5" value="{{ $obj->designation }}" />
        </div>
         <div class="col-md-12">
          <label class="col-form-label">Via</label>
          <input name="via" type="text"  class="form-control m-b-5" value="{{ $obj->via }}" placeholder="Facebook" />
        </div>
