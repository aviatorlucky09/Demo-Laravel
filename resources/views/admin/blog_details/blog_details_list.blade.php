...
@include('admin.blog_details.search_form')
<!-- begin panel -->
         ...
         <table id="datatable_vendor" class="table table-striped table-bordered">
            <thead>
                <tr>
                    ...
                    <th class="text-nowrap text-center">Blog Category</th>
...
<!-- end panel -->
 <script type="text/javascript">
       ...
       $(document).ready(function() {
             window.table =  $('#datatable_vendor').DataTable({
                ...
                "serverSide": true,
                "ajax": {
                        "url": "{{ route('admin.blog_details_processing') }}",
                        "type": "POST",
                        "data": {
                              "_token":"{{ csrf_token() }}",
                              "deleted":'{{ $deleted}}',
 ...
 function  searchBlogDetail(that) {
