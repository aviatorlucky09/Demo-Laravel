...
@include('admin.marinas.search_form')
   ...
   <table id="datatable_vendor" class="table table-striped table-bordered">
    <thead>
      <tr>
        ...
        <th class="text-nowrap text-center">Marina Name</th>
        <th class="text-nowrap text-center">Address</th>
        <th class="text-nowrap text-center">Body Of Water</th>
        <th class="text-nowrap text-center">Boats In Marina</th>
...
<script type="text/javascript">
 $(document).ready(function() {
   window.table =  $('#datatable_vendor').DataTable({
    ...
    "serverSide": true,
    "ajax": {
      "url": "{{ route('admin.marinas_processing') }}",
      "type": "POST",
      "data": {
        "_token":"{{ csrf_token() }}",
        "deleted":'{{ $deleted}}',
