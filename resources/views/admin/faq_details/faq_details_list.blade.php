...
@include('admin.faq_details.search_form')
<!-- begin panel -->
         ...
         <table id="datatable_vendor" class="table table-striped table-bordered">
            <thead>
                <tr>
                    ...
                    <th class="text-nowrap text-center">FAQ Category</th>
 ...
 <script type="text/javascript">
       ...
       $(document).ready(function() {
             window.table =  $('#datatable_vendor').DataTable({
                ...
                "serverSide": true,
                "ajax": {
                        "url": "{{ route('admin.faq_details_processing') }}",
                        "type": "POST",
                        "data": {
                              "_token":"{{ csrf_token() }}",
                              "deleted":'{{ $deleted}}',
