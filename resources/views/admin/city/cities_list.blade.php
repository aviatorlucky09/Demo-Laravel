...
<small>
 ...
 @include('admin.city.search_form')
<!-- begin panel -->
         ...
         <table id="datatable_vendor" class="table table-striped table-bordered">
            <thead>
                <tr>
                    ...
                    <th class="text-nowrap text-center">Country Name</th>
                    <th class="text-nowrap text-center">State Name</th>
                    <th class="text-nowrap text-center">City Name</th>
...
<!-- end panel -->
 <script type="text/javascript">
       ...
       $(document).ready(function() {
             window.table =  $('#datatable_vendor').DataTable({
                ...
                "serverSide": true,
                "ajax": {
                        "url": "{{ route('admin.cities_processing') }}",
                        "type": "POST",
                        "data": {
                              "_token":"{{ csrf_token() }}",
                              "deleted":'{{ $deleted}}',
 ...
 function  searchStateWiseCity(that) {
