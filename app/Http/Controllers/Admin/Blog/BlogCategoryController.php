...
{ 
    public function __construct()
    {
        ...
        $arr = array();
        $arr['view_folder'] = "admin.blog_categories";
        $arr['singular_name'] = "Blog Category";
        $arr['plural_name'] = "Blog Categories";
        $arr['table_name'] = "blog_categories";
        $arr['update_route_name'] = 'admin.blog_category_update';
        $arr['edit_route_name'] = 'admin.blog_category_edit';
        $arr['delete_route_name'] = 'admin.blog_category_delete';
        $arr['listing_url'] = ajaxUrl(route('admin.blog_categories'));
        $arr['create_url'] = ajaxUrl(route('admin.blog_category_create'));
        $this->config_arr =$arr;
    ...
    public function index(Request $request)
    {
      ...
      /* $blogCategories = BlogCategory::whereNull('parent_category_id')
    ...
    {   
       ...
       $allow_params[] =  "parent_category_id";
    ...
    public function findById($id){
         ...
         return BlogCategory::withTrashed()->where("id",$id)->first();
    }
