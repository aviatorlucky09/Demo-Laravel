...
{ 
    public function __construct()
    {
        ...
        $arr = array();
        $arr['view_folder'] = "admin.government_documents";
        $arr['singular_name'] = "Government Document";
        $arr['plural_name'] = "Government Documents";
        $arr['table_name'] = "government_documents";
        $arr['update_route_name'] = 'admin.government_document_update';
        $arr['edit_route_name'] = 'admin.government_document_edit';
        $arr['delete_route_name'] = 'admin.body_of_water_delete';
        $arr['listing_url'] = ajaxUrl(route('admin.government_documents'));
        $arr['create_url'] = ajaxUrl(route('admin.government_document_create'));
        $this->config_arr =$arr;
    ...
    public function processing(Request $request){
       ...
       $carr = $this->config_arr;     
        ...
        $query_obj = GovernmentDocument::query(); 
    ...
    public function findById($id){
         ...
         return GovernmentDocument::withTrashed()->where("id",$id)->first();
    }
