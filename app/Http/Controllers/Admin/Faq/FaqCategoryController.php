...
{ 
    public function __construct()
    {
        ...
        $arr = array();
        $arr['view_folder'] = "admin.faq_categories";
        $arr['singular_name'] = "FAQ Category";
        $arr['plural_name'] = "FAQ Categories";
        $arr['table_name'] = "faq_categories";
        $arr['update_route_name'] = 'admin.faq_category_update';
        $arr['edit_route_name'] = 'admin.faq_category_edit';
        $arr['delete_route_name'] = 'admin.faq_category_delete';
        $arr['listing_url'] = ajaxUrl(route('admin.faq_categories'));
        $arr['create_url'] = ajaxUrl(route('admin.faq_category_create'));
        $this->config_arr =$arr;
    ...
    public function findById($id){
         ...
         return FaqCategory::withTrashed()->where("id",$id)->first();
    }
