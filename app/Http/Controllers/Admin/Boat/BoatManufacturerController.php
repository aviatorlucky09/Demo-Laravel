...
class BoatManufacturerController extends Controller
{ 
    public function __construct()
    {
        $this->middleware('auth:admin');
        $arr = array();
        $arr['view_folder'] = "admin.boat_manufacturers";
        $arr['singular_name'] = "Boat Manufacturer";
        $arr['plural_name'] = "Boat Manufacturers";
        $arr['table_name'] = "boat_manufacturers";
        $arr['update_route_name'] = 'admin.boat_manufacturer_update';
        $arr['edit_route_name'] = 'admin.boat_manufacturer_edit';
        $arr['delete_route_name'] = 'admin.boat_manufacturer_delete';
        $arr['listing_url'] = ajaxUrl(route('admin.boat_manufacturers'));
        $arr['create_url'] = ajaxUrl(route('admin.boat_manufacturer_create'));
        $this->config_arr =$arr;
    ...
    public function processing(Request $request){
       ...
       $carr = $this->config_arr;     
        ...
        $query_obj = BoatManufacturer::query(); 
    ...
    public function getEmptyObject(){
         return new BoatManufacturer();
    }
    public function findById($id){
        
         return BoatManufacturer::withTrashed()->where("id",$id)->first();
    }
